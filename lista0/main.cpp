...
int main()
{
    ...
    // model.load_file("./bier127/bier127_n126_bounded-strongly-corr_01.ttp");
    ...
    std::cout << "\n========[ RESULTS ]========\n\n";
    std::cout << "|-> Best solution: " << best_member.solution << "\n";
    std::cout << "|-> Best solution fitness: " << best_member.fitness << "\n";
    std::cout << "|-> Knapsack value: " << model.knapsack_value << "\n";
    std::cout << "|-> Traveling time: " << model.knapsack_value - best_member.fitness << "\n";
