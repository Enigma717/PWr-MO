...
int main(int argc, char* argv[])
{
    ...
    std::size_t tournament_size{static_cast<std::size_t>(std::stoi(argv[1]))};
    ...
    //         std::stringstream results_path;
    //         results_path << "./csv/tuning/" << filename << "_subgroup" << tournament_size << ".csv";
    //         results_file.open(results_path.str());
    ...
    //         results_file << model.genetic_solver.crossing_probability << "; "
    //             << model.genetic_solver.mutation_probability << "; "
    //             << model.evaluate_fitness(solution.graph) << "; "
    //             << avg << "; "
    //             << elapsed_time << "\n";
    //     }
